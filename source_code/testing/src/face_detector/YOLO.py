...
class YOLOv5:
    ...
    def postprocessing(self, prediction_bboxes, imgs, conf_thresh=0.25, iou_thresh=0.1, max_detection=10):
    ...
    def __call__(self, imgs, conf_thresh=0.25, iou_thresh=0.45, max_detection=10):
